    ...
    public class SYSGetFileType443 : IClientWorkflowScript
    {
        ...
        public void OnClientWorkflowScriptExecute(Hyland.Unity.Application app, Hyland.Unity.ClientWorkflowEventArgs args)
        {
            ...
            try
            {
                ...
                if (objDocRendition.FileType.ID == IMAGE_FILE_TYPE)
                {
                    args.ScriptResult = true;
                    app.Diagnostics.WriteIf(Diagnostics.DiagnosticsLevel.Info, "Image File Format");
                }
                else
                {
                    args.ScriptResult = false;
                    app.Diagnostics.WriteIf(Diagnostics.DiagnosticsLevel.Info, "Not Image File Format");
                }
