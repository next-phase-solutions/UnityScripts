...
{
    /// <summary>
    /// Assigns the appropriate Processing Unit and Load Balanced User to App Processing queues
    ...
    ///      3. (11/23/2010-TT) Unknown change time, but script actually does a "least # documents assigned across 
    ///     lifecycle" assignment - see getNextUser() function
    ...
    public class DBPR_UnityScript_110 : IWorkflowScript
    {
        ...
        private const string ScriptName = "110 CIU-RULE-Assign App Proc Load Balance User from DB";
        ...
        private const string gLCNUM = "102";
        private const string gLCNUM2 = "319";
