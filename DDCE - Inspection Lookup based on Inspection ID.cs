// Skeleton generated by Hyland Unity Editor on 7/24/2017 8:22:40 PM
namespace DDCELookupBasedonInspectionID
{
    using System;
    using System.Text;
    using Hyland.Unity;
    ...
    /// <summary>
    /// DDCE - Lookup Based on Inspection ID - 354
    /// </summary>
    public class DDCELookupBasedonInspectionID : Hyland.Unity.IWorkflowScript
    {
        #region User-Configurable Script Settings
        // Script name for diagnostics logging
        private const string ScriptName = "354 - DDCE - Lookup based on Inspection ID";
                    ...
                    try
                    {
                        ...
                        using (OdbcDataReader reader = command.ExecuteReader())
                        {
                            if (reader.HasRows)
                            {
                                ...
                                app.Diagnostics.WriteIf(Diagnostics.DiagnosticsLevel.Verbose, string.Format(strLicType.ToString()));
                                ...
                                if (!String.IsNullOrEmpty(strLicType))
                                {
                                    ...
                                    if (kwtLicType != null)
                                        kwdLicType = CreateKeywordHelper(kwtLicType, strLicType.Trim());
                                }
                                ...
                                using (DocumentLock documentLock = _currentDocument.LockDocument())
                                {
                                    ...
                                    //if (kwdLicType != null) keyModifier.UpdateKeyword(kwdLicenseType,kwdLicType);
                                    ...
                                    string output = String.Format("Keyword: '{0}' Value: '{1}', {29}Keyword: '{2}' Value: '{3}', {29}Keyword: '{4}' Value: '{5}', {29}Keyword: '{6}' Value: '{7}'," +
                                        ...
                                        "No KW", "Not Returned by Query", gSaveToVisitNum, strVisitNum, gSaveToDisposition, strDisposition, gSaveToCity, strCity, gSaveToCounty, strCounty,
