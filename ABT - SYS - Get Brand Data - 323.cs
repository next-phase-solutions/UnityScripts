...
namespace CRDEMailAddressLookUp
{
    ...
    public class CRDEMailAddressLookUp : IWorkflowScript
    {
        ...
        private const string ScriptName = "ABT - SYS - Get Brand Data - 323";
        ...
        private const string gSaveToLicNum = "Brand Lic Number";
        private const string gSaveToKeyName = "Key Name";
        private const string gSaveToValNum = "Validation Number";
        private const string gSaveToTranNum = "Tran Code";
                        ...
                        using (OdbcDataReader reader = command.ExecuteReader())
                        {
                            if (reader.HasRows)
                            {
                                ...
                                using (DocumentLock documentLock = _currentDocument.LockDocument())
                                {
                                    ...
                                    if (kwdTranCode != null) keyModifier.AddKeyword(kwdTranCode);
                                    if (kwdKeyName != null) keyModifier.AddKeyword(kwdKeyName);
                                    if (kwdValNum != null) keyModifier.AddKeyword(kwdValNum);
                                    if (kwdBrandNum != null) keyModifier.AddKeyword(kwdBrandNum);
