...
namespace UnityScripts
{
    ...
    public class DBPR_UnityScript_432 : IWorkflowScript
    {
        ...
        private const string ScriptName = "211 - HR - Get Field Office Information";
        ...
        private const string gSaveToKeywordName = "District";
        private string strBatchNum = "";
                        ...
                        using (OdbcDataReader reader = command.ExecuteReader())
                        {
                            if (reader.HasRows)
                            {
                                ...
                                using (DocumentLock documentLock = _currentDocument.LockDocument())
                                {
                                    ...
                                    if (kwdDist != null) keyModifier.AddKeyword(kwdDist);
